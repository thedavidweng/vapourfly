...
| Library card actions | — | Yes | Every Library card exposes compact Recommend, Copy AppID, and Open Steam Store actions. Recommend opens Recommendations with that AppID as seed. |
...
- [ ] **Library**: loads demo games; skeleton appears briefly then clears; cards show deterministic illustrated offline covers; Search and All/Installed/Unplayed/Hidden scopes filter correctly; labelled Deck, Controller, playtime, genre, tag, and sort controls work; the gear menu exposes ProtonDB, HLTB, exclusions, and descending sort; category chips work; **Load more** adds 48 cards per click; card actions and overflow menu expose Recommend, Copy AppID, Open Steam Store; four cards plus the complete insights rail stay on-screen at 1280–1440px, and the rail moves below at 1024–1279px.
